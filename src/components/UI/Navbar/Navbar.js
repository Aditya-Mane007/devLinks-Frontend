      ...
      <div className="w-full h-fit sm:py-4">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center sm:rounded-[.5rem] bg-PrimaryWhite">
          {isPreview ? (
            <Link
              href="/"
              className="px-4 md:px-4 py-2 border border-PrimaryPurple text-PrimaryPurple hover:bg-SecondaryPurple rounded-[.5rem] font-semibold -tracking-tighter flex items-center mr-1"
            >
              Back to Editor
            </Link>
          ) : (
              ...
              <div className="flex">
                ...
                >
                  ...
                  >
                    <path
                      fill={
                        router.pathname === "/profile" ? "#633CFF" : "#737373"
                      }
